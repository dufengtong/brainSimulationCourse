TITLE fast.mod   squid sodium, potassium, k1 potassium, k3 potassium and leak channels
 
COMMENT
 This is the fast spiking without adaptation treatment based on Hodgkin-Huxley treatment
