...
#define nrn_init _nrn_init__fast
#define _nrn_initial _nrn_initial__fast
#define nrn_cur _nrn_cur__fast
#define _nrn_current _nrn_current__fast
#define nrn_jacob _nrn_jacob__fast
#define nrn_state _nrn_state__fast
#define _net_receive _net_receive__fast 
#define rates rates__fast 
#define states states__fast 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 fast D:/dft/pycourse/brainSimulation/hw3/mod/fast.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "fast.mod   squid sodium, potassium, k1 potassium, k3 potassium and leak channels";
